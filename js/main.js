...
function adaptive_header(w,h) {
	...
	if(w<767){
		...
		if(headerNav.hasClass('done')){
			headerNav.removeClass('done').insertAfter($('.nav__logolink'));
		}
	}
}
...
function forms(){
	...
	$.each($('input.phone'), function(index, val) {
		$(this).attr('type','tel');
		$(this).focus(function(){
			$(this).inputmask('+9(999) 999 9999',{clearIncomplete: true,clearMaskOnLostFocus: true,
